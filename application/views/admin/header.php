		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="bs-examplenavbar-collapse-1">
				...
				<ul class="nav navbar-nav navbar-left">
					<li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" ariaexpanded="false"><span <span class="glyphicon glyphicon-list-alt"></span> Laporan</a>
				<ul class="dropdown-menu">
					<li><a href="<?php echo base_url().'admin/laporan_buku' ?>">
						<i class="glyphicon glyphicon-file"></i>Laporan Data Buku</a></li>
					<li><a href="<?php echo base_url().'admin/laporan_anggota' ?>">
						<i class="glyphicon glyphicon-user"></i>Laporan Data Anggota</a></li>
					<li><a href="<?php echo base_url().'admin/laporan_transaksi' ?>">
						<i class="glyphicon glyphicon-sort"></i>Laporan Data Transaksi</a></li>
				</ul></ul>
